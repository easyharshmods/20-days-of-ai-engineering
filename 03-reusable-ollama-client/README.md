# Build a Reusable Ollama Client in Python

## What we are building

Refactor the raw Ollama call into reusable files.
...
The terminal prints an answer from a reusable client.
