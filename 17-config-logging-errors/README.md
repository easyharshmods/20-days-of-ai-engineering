# Add Config, Logging, and Error Handling

## What we are building

Add production-minded improvements after the app works.
...
The script logs progress and handles failures.
