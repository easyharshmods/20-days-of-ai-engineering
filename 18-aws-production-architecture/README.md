# Map the Local AI App to AWS Production Architecture
...
```text
18-aws-production-architecture/
  README.md
  requirements.txt
  sample/aws_architecture.json
  code/main.py
```
...
```bash
cd 18-aws-production-architecture
...
A local-to-AWS service map prints.
